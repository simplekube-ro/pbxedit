...
- **THEN** the hunk governing `EE0000000000000000000001` `knownRegions` offers `ours` and `theirs` only, whatever the hunk's own texts show, and the command exits `3` writing nothing
